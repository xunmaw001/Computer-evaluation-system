<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="类型名称" prop="leixingmingcheng">
          <el-input v-model="ruleForm.leixingmingcheng" 
              placeholder="类型名称" clearable  :readonly="ro.leixingmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="类型名称" prop="leixingmingcheng">
              <el-input v-model="ruleForm.leixingmingcheng" 
