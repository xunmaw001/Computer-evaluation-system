<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分类名称" prop="fenleimingcheng">
          <el-input v-model="ruleForm.fenleimingcheng" 
              placeholder="分类名称" clearable  :readonly="ro.fenleimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分类名称" prop="fenleimingcheng">
              <el-input v-model="ruleForm.fenleimingcheng" 
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='fenleimingcheng'){
            this.ruleForm.fenleimingcheng = obj[o];
	    this.ro.fenleimingcheng = true;
            continue;
          }
          if(o=='shuliang'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `diannaofenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.diannaofenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
